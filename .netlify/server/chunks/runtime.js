...
function cloneUnlessOtherwiseSpecified(value, options2) {
	return options2.clone !== false && options2.isMergeableObject(value)
		? deepmerge(emptyTarget(value), value, options2)
		: value;
}
...
function mergeObject(target, source, options2) {
	...
	getKeys(source).forEach(function (key) {
		...
		if (
			propertyIsOnObject(target, key) &&
			options2.isMergeableObject(source[key])
		) {
			destination[key] = getMergeFunction(key, options2)(
				target[key],
				source[key],
				options2,
			);
...
function memoize(fn, options2) {
	...
	var serializer =
		options2 && options2.serializer ? options2.serializer : serializerDefault;
	var strategy =
		options2 && options2.strategy ? options2.strategy : strategyDefault;
	return strategy(fn, {
		cache,
		serializer,
	});
	...
	(function () {
		function IntlMessageFormat2(message, locales, overrideFormats, opts) {
			...
			this.resolvedOptions = function () {
				...
				return {
					locale:
						((_a3 = _this.resolvedLocale) === null || _a3 === void 0
							? void 0
							: _a3.toString()) ||
...
const createNumberFormatter = monadicMemoize(_a2 => {
	var _b = _a2,
		{ locale, format } = _b,
		options2 = __objRest(_b, ["locale", "format"]);
	if (locale == null) {
...
const createDateFormatter = monadicMemoize(_c => {
	var _d = _c,
		{ locale, format } = _d,
		options2 = __objRest(_d, ["locale", "format"]);
	if (locale == null) {
...
const createTimeFormatter = monadicMemoize(_e => {
	var _f = _e,
		{ locale, format } = _f,
		options2 = __objRest(_f, ["locale", "format"]);
	if (locale == null) {
		throw new Error(
...
const getMessageFormatter = monadicMemoize(
	...
	(message, locale = getCurrentLocale()) =>
...
const formatMessage = (id, options2 = {}) => {
	...
	if (!message) {
		message =
			(_d =
				(_c =
					(_b = (_a2 = getOptions()).handleMissingMessage) == null
						? void 0
						: _b.call(_a2, { locale, id, defaultValue })) != null
					? _c
					: defaultValue) != null
				? _d
				: id;
